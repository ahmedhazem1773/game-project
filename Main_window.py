...
class button (pygame.sprite.Sprite) :
    def __init__(self,pos, text_button=None, size=None ,font_path=None,color="white", surface=False ,hover_surface=False,bg_color=None, groups=None):
